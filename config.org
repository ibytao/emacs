...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package web-mode
    ...
    (add-hook 'web-mode-hook
              (lambda ()
                (add-to-list (make-local-variable 'company-backends)
                             '(company-tide company-tabnine company-css company-web-html company-files))
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun setup-tide-mode ()
    ...
    (company-mode +1)
    (add-to-list 'company-backends '(company-tide company-tabnine))
    )
  ...
  #+begin_src emacs-lisp
    ...
    (use-package company-jedi
      ...
      (add-hook 'python-mode-hook (lambda ()
                                    (add-to-list 'company-backends '(company-jedi company-tabnine))))
